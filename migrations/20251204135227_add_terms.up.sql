...
-- Insert initial terms content from current hardcoded version
INSERT INTO terms (id, content, created_at, updated_at, updated_by)
VALUES (
    UUID_TO_BIN('019af3e1-2caa-788c-98da-b4d0a5e1c25a'),
    '## 第1条（適用範囲）
...
2. 本サービスの運営者、もしくは運営者が委託する第三者が運営するサービス、加えていずれの場合も本サービスが使用するドメイン(eddibb.cc)を含むサービス

---

問い合わせ先: abuse あっとま～く eddibb.cc
',
    NOW(3),
    NOW(3),
    NULL
